...
```python
import torch
from imaginaire.constants import get_cosmos_predict2_checkpoint
...
pipe = Video2WorldPipeline.from_config(
    ...
    dit_path=get_cosmos_predict2_checkpoint(model_size="2B", model_type="Video2World", resolution=720, fps=16)
)
