...
T5_TEXT_ENCODER_NUM_TOKENS = 512
T5_TEXT_ENCODER_EMBED_DIM = 1024
...
COSMOS_REASON1_TEXT_ENCODER_NUM_TOKENS = 512
COSMOS_REASON1_TEXT_ENCODER_EMBED_DIM = 100352

if TEXT_ENCODER_CLASS == TextEncoderClass.COSMOS_REASON1:
    TEXT_ENCODER_NUM_TOKENS = COSMOS_REASON1_TEXT_ENCODER_NUM_TOKENS
    TEXT_ENCODER_EMBED_DIM = COSMOS_REASON1_TEXT_ENCODER_EMBED_DIM
elif TEXT_ENCODER_CLASS == TextEncoderClass.T5:
    TEXT_ENCODER_NUM_TOKENS = T5_TEXT_ENCODER_NUM_TOKENS
    TEXT_ENCODER_EMBED_DIM = T5_TEXT_ENCODER_EMBED_DIM
else:
